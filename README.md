...
Projet scolaire consistant à développer une application e-commerce complète.
...
- Possibilité d’achat pour les utilisateurs connectés, consultation uniquement pour les utilisateurs non connectés
- Gestion des taux d’intérêt par produit
...
```bash
git clone https://github.com/mykytamyronenko/e-shop.git
